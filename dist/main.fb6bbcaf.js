...
// Your Tasty API Key
var apiKey = '708341e91cmsha693c16a8a30723p1a731bjsndff5df3759ec'; // Replace with your actual API key
...
function _fetchRecipes() {
  _fetchRecipes = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response, data;
...
function _spinWheel() {
  _spinWheel = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          ...
          randomRecipe = recipes[Math.floor(Math.random() * recipes.length)]; // Wait for a brief moment before stopping the wheel
          setTimeout(function () {
...
document.addEventListener("DOMContentLoaded", function () {
  var colors = ["#81C784", "#FF6F61", "#FFD54F", "#FFB74D"];
  var heading = document.getElementById('colorful-heading');
